...
export const STRINGS = {
  ...
  'auth.newHere': { en: 'New to Wiseup?', hi: 'Wiseup पर नए हैं?' },
  ...
  'careers.education': { en: 'Education Path', hi: 'शिक्षा पथ' },
  'careers.avgSalary': { en: 'Avg. Starting Salary', hi: 'औसत शुरुआती वेतन' },
  'careers.outlook': { en: 'Career Outlook', hi: 'करियर संभावनाएं' },
  ...
  // ── Quiz ─────────────────────────────────────────────────────
  'quiz.title': { en: 'Test Your Knowledge', hi: 'अपना ज्ञान परखें' },
  'quiz.subtitle': { en: 'Pick your grade and subject for a quick quiz, and earn XP for every correct answer.', hi: 'त्वरित प्रश्नोत्तरी के लिए अपनी कक्षा और विषय चुनें, और हर सही उत्तर पर XP कमाएं।' },
  'quiz.selectGrade': { en: 'Select Grade', hi: 'कक्षा चुनें' },
  'quiz.selectSubject': { en: 'Select Subject', hi: 'विषय चुनें' },
  'quiz.selectChapter': { en: 'Select Chapter', hi: 'अध्याय चुनें' },
  'quiz.questions': { en: 'questions', hi: 'प्रश्न' },
  'quiz.languageNote': { en: 'Questions will show in', hi: 'प्रश्न इस भाषा में दिखेंगे' },
  'quiz.start': { en: 'Start Quiz', hi: 'प्रश्नोत्तरी शुरू करें' },
  'quiz.noQuiz': { en: 'No quiz available yet for this grade and subject.', hi: 'इस कक्षा और विषय के लिए अभी कोई प्रश्नोत्तरी उपलब्ध नहीं है।' },
  'quiz.questionOf': { en: 'Question {n} of {total}', hi: 'प्रश्न {n} / {total}' },
  'quiz.next': { en: 'Next Question', hi: 'अगला प्रश्न' },
  'quiz.finish': { en: 'See Results', hi: 'परिणाम देखें' },
  'quiz.xpEarned': { en: 'You earned {xp} XP. Keep practicing to master this subject!', hi: 'आपने {xp} XP कमाए। इस विषय में महारत हासिल करने के लिए अभ्यास जारी रखें!' },
  'quiz.retry': { en: 'Try Again', hi: 'फिर से प्रयास करें' },
  'quiz.changeSetup': { en: 'Change Grade / Subject', hi: 'कक्षा/विषय बदलें' },
